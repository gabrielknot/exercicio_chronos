...
sed -i "s/DB_ENV_PORT/$DB_ENV_PORT/g" .env

sed -i "s/DB_ENV_DATABASE/$DB_ENV_DATABASE/g" .env

sed -i "s/DB_ENV_USERNAME/$DB_ENV_USERNAME/g" .env



sed -i "s/DB_ENV_PASSWORD/$DB_ENV_PASSWORD/g" .env
